...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="w-100 bg-white rounded-lg shadow-md overflow-hidden">
        <div class="flex">
            <img class="w-1/3 object-cover" src="https://via.placeholder.com/150" alt="Image">
            <div class="w-2/3 p-4">
                ...
                <div class="mt-4 flex justify-between items-center">
                    <button class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center">
                        Voir Plus
                    </button>
