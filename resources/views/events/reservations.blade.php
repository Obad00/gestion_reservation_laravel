                ...
                @foreach ($reservations as $reservation)
                    <tr>
                        ...
                        @elseif ($reservation->statut  == 'confirmee')
                            ...
                            <span
                            class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text-cyan-500">
                            {{ $reservation->statut }}
                    ...
                    <td>
                        ...
                        <div class="flex"><form action="{{ route('reservations.accept', $reservation->id) }}" method="POST">
                            @csrf
                            <input type="hidden" name="etat" placeholder="nom role">
                            <button
                                class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center  px-2 py-1 text-center mr-2"
                                type="submit"> Accepter</button>
                        </form>
                        ...
                        <form action="{{ route('reservations.decline', $reservation->id) }}" method="POST">
                            ...
                            <input type="hidden" name="etat" placeholder="nom role">
                            <button
                                class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center px-2 py-1 text-center mr-2"
                                type="submit"> Decliner</button>
                        </form></div>

                            {{-- <a href="#" class="ml-2 text-red-600 hover:text-red-900"
                                onclick="openModal('modelConfirm')"><svg width="18" height="18" viewBox="0 0 18 18"
                                    ...
                                    <path
                                        ...
                                        stroke="#E06F1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </a> --}}
                        </td>
                    </tr>
