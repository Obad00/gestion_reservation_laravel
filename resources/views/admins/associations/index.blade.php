    ...
    <tbody class="bg-white divide-y my-7 divide-gray-200">
        ...
        <tr>
            ...
            <td class="px-6 gap-3 pt-6 whitespace-nowrap flex  text-sm font-medium">
                <a href="{{ route('admin.associations.show', $association->id) }}" class="text-indigo-600 hover:text-indigo-900"><svg width="22" height="15" viewBox="0 0 22 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="modelConfirm" class="fixed hidden z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4 ">
            <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <form action="{{ route('association.bloque', $association->id  ) }}" method="POST">
                        @csrf
                        @method('put')
