    ...
    <tbody class="bg-white divide-y my-7 divide-gray-200">
        ...
        <tr>
            ...
            <td class="px-6 gap-3 pt-6 whitespace-nowrap flex  text-sm font-medium">
                <a href="{{ route('associations.show', $association->id) }}" class="text-indigo-600 hover:text-indigo-900"><svg width="22" height="15" viewBox="0 0 22 15" fill="none" xmlns="http://www.w3.org/2000/svg">
