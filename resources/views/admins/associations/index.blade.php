    ...
    <tbody class="bg-white divide-y my-7 divide-gray-200">
        ...
        <tr>
            ...
            <td class="px-6 gap-3 pt-6 whitespace-nowrap flex  text-sm font-medium">
                ...
                <a href="#" class="ml-2 text-red-600 hover:text-red-900"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
