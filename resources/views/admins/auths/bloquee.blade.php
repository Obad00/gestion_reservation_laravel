<x-admin-layout>
    <div class="flex justify-between mb-9">
        ...
        <a href="{{ route('admins.index') }}"><button
                ...
                type="submit">Administrateurs </button></a>
                ...
                <div id="modelConfirm"
                    ...
                    <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
                        ...
                        <div class="p-6 pt-0 text-center">
                            ...
                            <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">Êtes-vous sûr de vouloir debloquer cette Administrateurs ?</h3>
