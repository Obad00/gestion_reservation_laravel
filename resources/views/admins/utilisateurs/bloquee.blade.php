<x-admin-layout>
    <div class="flex justify-between mb-9">
        ...
        <a href="{{ route('utilisateurs.index') }}"><button
                class="text-white bg-orange hover:bg-gray-400 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center px-3 py-2.5 text-center mr-2"
